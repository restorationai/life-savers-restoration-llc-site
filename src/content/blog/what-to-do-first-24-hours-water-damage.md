...
generated_at: "2026-08-05T18:33:45.293225+00:00"
...
faq: [{"question": "How long do I have before water damage becomes a mold problem?", "answer": "Mold spores are present in virtually every indoor environment and only need moisture and a surface to colonize. Under warm conditions \u2014 which are common in Henderson homes \u2014 visible mold growth can appear on drywall, wood framing, and insulation in as little as 24 to 48 hours after saturation. This is why the drying process needs to begin within the first day, not after the weekend."}, {"question": "Does my homeowner's insurance cover water damage?", "answer": "Most standard homeowner policies in Nevada cover sudden and accidental water damage \u2014 a burst pipe, a failed appliance hose, an overflow from a fixture. They typically exclude gradual leaks, seepage, and flooding from outside the home (which requires a separate flood policy through the National Flood Insurance Program or a private carrier). The documentation you create in the first hours is often what determines whether a claim is approved or denied, so photograph everything before cleanup begins."}, {"question": "Can I stay in my home while water damage is being dried out?", "answer": "It depends on the extent and the water source. If the affected area is limited to one room, the water was clean (a supply line, not a sewer), and there is no electrical hazard, many families remain in the home during the drying process. If the damage is widespread, if sewage is involved, or if mold is already present, temporary relocation is often the safer choice \u2014 and your homeowner's policy may cover additional living expenses in those situations."}, {"question": "What is the difference between a restoration company and a general contractor for water damage repairs?", "answer": "A restoration company focuses on emergency mitigation \u2014 extracting water, drying the structure, testing moisture levels, and removing unsalvageable materials. A general contractor handles the rebuild: new drywall, flooring, cabinetry, and paint. Some restoration companies, including full-service firms, handle both phases under one contract, which simplifies coordination and keeps your claim documentation in one place. If you hire them separately, make sure the restoration company provides a written drying report before the contractor begins reconstruction."}]
...
## Step 3: Remove Standing Water and Begin Ventilation

Once you have your documentation, you can start limiting the spread.

1. **Remove standing water** with a wet/dry shop vacuum, mop, or towels. Even a quarter inch of water on a concrete slab can wick into adjacent drywall and framing.
...
Some instinctive responses to a water emergency can make the situation significantly worse.

- **Do not use a standard household vacuum.** Only a wet/dry vacuum rated for liquid extraction is safe. A regular vacuum motor will be destroyed and can create an electrocution hazard.
- **Do not run the HVAC system** if there is visible mold or if the water source was a sewer or toilet overflow. The air handler will distribute contaminated particles through every duct in the house.
- **Do not pull up flooring yourself** if you do not know what is beneath it. Older Henderson homes built before the 1980s may have vinyl flooring or floor tile that contains asbestos. Disturbing it without testing creates a hazmat situation.
- **Do not throw away damaged materials** before your adjuster has seen them or before a restoration company has documented them. Disposing of evidence prematurely can complicate or void a claim.
- **Do not assume the damage is surface-level.** Water follows gravity and the path of least resistance. A ceiling stain is often the last place water arrived, not the first. The source may be a floor or two above the visible damage.
